...
| `windows-msvc-2022-relwithdebinfo` | 带调试信息的发布版 | `build/msvc2022/RelWithDebInfo` |
...
# RelWithDebInfo 构建（带调试信息的发布版）
cmake --preset windows-msvc-2022-relwithdebinfo
cmake --build build/msvc2022/RelWithDebInfo --config RelWithDebInfo -j 8
```
...
# RelWithDebInfo 版本
.\build\msvc2022\RelWithDebInfo\RelWithDebInfo\EnhanceVision.exe
```
