---
name: "qt-debugging"
description: "Qt Debugging — diagnostic approach, verbose output, common failure categories, memory leak detection, and useful diagnostic patterns."
...
```python
# Track live QObject count using objgraph
import objgraph
