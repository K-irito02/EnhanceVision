...
Rectangle {
    ...
    FolderDialog {
        ...
        title: qsTr("选择默认保存路径")
        currentFolder: "file:///" + SettingsController.effectiveDefaultSavePath
        onAccepted: {
            var path = selectedFolder.toString().replace("file:///", "")
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                TextField {
                                    ...
                                    Layout.fillWidth: true
                                    text: root.nativePathForDisplay(SettingsController.effectiveDataPath)
                                    readOnly: true
                                    size: "sm"
                                }
                            ...
                            Rectangle {
                                visible: SettingsController.dataPathFallbackActive
                                Layout.fillWidth: true
                                implicitHeight: dataPathWarning.implicitHeight + 12
                                radius: 8
                                color: Theme.colors.warningSubtleBg
                                border.width: 1
                                ...
                                Text {
                                    ...
                                    color: Theme.colors.warning
                                    font.pixelSize: 11
                                    text: qsTr("当前配置的应用数据目录无效，已回退到安全默认目录。原因：%1").arg(SettingsController.dataPathFallbackReason)
                                }
                            }
                        }
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                TextField {
                                    id: savePathField
                                    Layout.fillWidth: true
                                    text: root.nativePathForDisplay(SettingsController.effectiveDefaultSavePath)
                                    readOnly: true
                                    size: "sm"
                                }
                            ...
                            Rectangle {
                                visible: SettingsController.defaultSavePathFallbackActive
                                Layout.fillWidth: true
                                implicitHeight: exportPathWarning.implicitHeight + 12
                                radius: 8
                                color: Theme.colors.warningSubtleBg
                                border.width: 1
                                border.color: Theme.colors.warning
                                ...
                                Text {
                                    id: exportPathWarning
                                    anchors.fill: parent
                                    anchors.margins: 8
                                    wrapMode: Text.Wrap
                                    color: Theme.colors.warning
                                    font.pixelSize: 11
                                    text: qsTr("当前配置的默认导出路径无效，已回退到安全默认目录。原因：%1").arg(SettingsController.defaultSavePathFallbackReason)
                                }
                            }
                        }
